...
def logout(login_url="http://10.0.0.11:8090/logout.xml", username=None, password=None, timeout=10):
    ...
    # server takes header body data in binary ( still server is local & runs on HTTP
